...
const equipmentSelections: FilterCheckbox[] = equipmentEnum.map((a) => ({group: "muscle", selection: a, value: false}))
const emphasisSelections: FilterCheckbox[] = emphasisEnum.map((a) => ({group: "muscle", selection: a, value: false}))
const difficultySelections: FilterCheckbox[] = difficultyEnum.map((a) => ({group: "muscle", selection: a, value: false}))
